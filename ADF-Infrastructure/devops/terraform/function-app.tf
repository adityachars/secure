...
#   name                = "northstar-service-plan-${local.environment}"
#   resource_group_name = data.azurerm_resource_group.rg.name
...
#   name                        = "northstar-function-app-${local.environment}"
#   resource_group_name         = data.azurerm_resource_group.rg.name
#   location                    = data.azurerm_resource_group.rg.location
...
#   functions_extension_version = "~4"
#   builtin_logging_enabled     = false
#   app_settings                = merge(azurerm_linux_function_app.function_app.app_settings, var.disabled_functions)
...
# resource "azurerm_app_service_slot_virtual_network_swift_connection" "slot_vnet" {
#   slot_name      = azurerm_linux_function_app_slot.app_slot.name
#   app_service_id = azurerm_linux_function_app.function_app.id
#   subnet_id      = azurerm_subnet.backend.id
# }
