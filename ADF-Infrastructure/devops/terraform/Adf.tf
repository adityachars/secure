locals{
  globalparameters = [{
      name   = "Environment"
      type   = "String"
      value  = var.gpenvironment[local.environment]
    },
    {
      name   = "BlobBaseUrl"
      type   = "String"
    ...
    },
    {
      ...
      type   = "String"
      value  = var.northstarapiuri[local.environment]
    },
    {
      name   = "WFM1001UBA"
      type   = "String"
    ...
    },
    {
      ...
      type   = "String"
      value  = var.oicapienvironmentidentifier[local.environment]
    },
    {
    ...
    {
      name   = "UBA_1002_ERP_SourceFolder"
      type   = "String"
      value  = var.erp1002erpsourcefolder[local.environment]
    },
    {
      name   = "UBA_1002_ERP_AttachmentSourceFolder"
      type   = "String"
      value  = var.erp1002erpattachmentsourcefolder[local.environment]
    },
    {
      name   = "UBA_1002_ERP_DestinationFolder"
      type   = "String"
      value  = var.erp1002erpdestinationfolder[local.environment]
    },
    {
      name   = "UBA_1002_ERP_AttachmentDestinationFolder"
      type   = "String"
      value  = var.erp1002erpattachmentdestinationfolder[local.environment]
    },
    {
      name   = "UBA_1002_ERP_ArchiveFailed"
      type   = "String"
      value  = var.erp1002erparchivefailed[local.environment]
    },
    {
      name   = "UBA_1002_ERP_Archive"
      type   = "String"
      value  = var.erp1002erparchive[local.environment]
    },
    {
      name   = "UBA_1002_ERP_ArchiveAttachment"
      type   = "String"
      value  = var.erp1002erparchiveattachment[local.environment]
    },
    {
      name   = "UBA_1002_ERP_ArchiveFailedAttachment"
      type   = "String"
      value  = var.erp1002erparchivefailedattachment[local.environment]
    },
    {
      name   = "UBA_1002_ERP_DestinationFolder_Callout"
      type   = "String"
      value  = var.erp1002erpdestinationfoldercallout[local.environment]
    }
  ]
}

resource "azurerm_data_factory" "northstaradf" {
  ...
  dynamic "vsts_configuration" {
    ...
    content {
      ...
      repository_name = "Northstar.securitas.Adf.common"
      root_folder     = "/"
  ...
  dynamic "global_parameter" {
    for_each = local.globalparameters
    content {
